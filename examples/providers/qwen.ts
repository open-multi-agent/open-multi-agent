/**
 * Multi-Agent Team Collaboration with Qwen
 *
 * Three specialized agents (architect, developer, reviewer) collaborate via `runTeam()`
 * to build a minimal Express.js REST API. Every agent uses Qwen via DashScope's OpenAI-compatible adapter.
 *
 * Run:
 ...
 *
 * Available models:
 *   qwen-plus  — Balanced Qwen model for general tasks (default)
 *   qwen-max   — Larger Qwen model for complex reasoning
 *   qwen-turbo — Fast Qwen model for lower-latency tasks
 */
