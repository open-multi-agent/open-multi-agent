 ...
 * to build a minimal Express.js REST API. Every agent uses Moonshot through the OpenAI-compatible adapter.
 *
 * Run:
 ...
 *
 * Available models:
 *   kimi-k2-0711-preview  — agentic coding and tool-use model
