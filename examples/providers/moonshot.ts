/**
 * Multi-Agent Team Collaboration with Moonshot (Kimi)
 *
 * Three specialized agents (architect, developer, reviewer) collaborate via `runTeam()`
 * to build a minimal Express.js REST API. Every agent uses Moonshot's OpenAI-compatible API.
 *
 * Run:
 ...
 *
 * Available models:
 *   kimi-k2-0905-preview  — agentic coding and tool-use model
 *   kimi-k2-turbo-preview — faster Kimi K2 variant
 *   moonshot-v1-8k       — general-purpose model with an 8k context window
 *   moonshot-v1-32k      — general-purpose model with a 32k context window
 *   moonshot-v1-128k     — general-purpose model with a 128k context window
 */
...
// ---------------------------------------------------------------------------
// Agent definitions (all using Moonshot via the OpenAI-compatible adapter)
// ---------------------------------------------------------------------------
