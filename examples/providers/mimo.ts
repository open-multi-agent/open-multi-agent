/**
 * Multi-Agent Team Collaboration with MiMo
 *
 ...
 *   Token Plan keys (tp-...) also need MIMO_BASE_URL set to the cluster URL
 *   shown on your subscription page, for example https://token-plan-cn.xiaomimimo.com/v1.
 *
 * Available models:
 *   mimo-v2.5-pro
 *   mimo-v2.5
...
// ---------------------------------------------------------------------------
// Agent definitions (all using MiMo)
// ---------------------------------------------------------------------------
...
const goal = `Create a minimal Express.js REST API in /tmp/mimo-api/ with:
